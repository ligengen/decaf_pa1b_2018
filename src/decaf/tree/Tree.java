...
public abstract class Tree {
    ...
    public static class Assign extends Tree {
        ...
        public Assign(String ident, Expr expr, Location loc) {
            super(ASSIGN, loc);
            this.ident = ident;
            this.expr = expr;
            use_stmt = true;
    ...
    public static class Guard extends Tree {
        ...
        public Guard(Location loc, List<Tree> ilist, Tree ifsubstmt) {
            super(GUARD, loc);
            if(ilist == null || ifsubstmt == null)
                empty = true;
            else {
                this.stmts = ilist;
